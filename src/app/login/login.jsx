  ...
  return (
    <div className="container px-4 sm:px-8 lg:px-24 mx-auto py-12 lg:py-24">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        ...
        <div className="border-2 p-6 md:p-10 lg:p-12 bg-white rounded-lg shadow-lg">
          <h6 className="text-2xl md:text-3xl font-semibold text-primary text-center mb-8 lg:mb-12">
            Sign In
          </h6>
